...
# MAGIC %run "/Workspaces//CCU036_01/CCU036_01-D01-parameters"
...
# MAGIC select * from  .ccu036_01_codelist_vaccine_products 
...
# MAGIC FROM .ccu036_01_in_vaccine_status__archive AS vaccination_raw
...
# MAGIC LEFT JOIN (SELECT code, name FROM .ccu036_01_codelist_vaccine_products WHERE left(name,16)="COVID19_vaccine_") AS product ON vaccination_raw.VACCINE_PRODUCT_CODE = product.code
# MAGIC LEFT JOIN (SELECT * FROM .ccu036_01_codelist_vaccine_products WHERE left(name,16)="COVID19_vaccine_") AS procedure ON vaccination_raw.VACCINATION_PROCEDURE_CODE = procedure.code
# MAGIC LEFT JOIN (SELECT code, name FROM .ccu036_01_codelist_vaccine_products WHERE left(name,16)="COVID19_vaccine_") AS situation ON vaccination_raw.VACCINATION_SITUATION_CODE = situation.code;
# MAGIC
...
#***REMOVED***Create dose specific vaccination tables
...
# MAGIC %sql
# MAGIC describe extended .ccu036_01_vaccination